        ...
        <div class="col-12 text-md-start">
            <div class="row text-sm-center text-md-start">
                ...
                <div class="col-12 col-md-3 col-lg-3 mx-auto mt-3">
                    <h5 class="text-uppercase mb-4 text-warning">Happy Cart</h5>
                    <p>Here we are the happyCart.lk&trade; to support you for accomplish your dessire by selling high
                        quality products.</p>
                </div>

                <div class="col-12 col-md-3 col-lg-2 mx-auto mt-3">
                    <p>Copyright &copy;2021 Happy Cart All Right Reserved</p>
                </div>
                ...
                <div class="col-12 col-md-4 col-lg-3 mx-auto mt-3">
                    ...
                    <p><i class="bi bi-house-door-fill"></i> Amar Street,Colombo 10,Sri Lanka.</p>
                    <p><i class="bi bi-envelope-fill"></i> HappyCart@gmail.com</p>
                    <p><i class="bi bi-telephone-fill"></i> +94 112 787654</p>
                    <p><i class="bi bi-printer-fill"></i> +94 112 782634</p>
